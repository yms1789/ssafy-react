...
DescriptionList.propTypes = {
  statusMessage: PropTypes.arrayOf(PropTypes.string).isRequired, // string[] or Array<string>
  imageType: PropTypes.oneOf(["react", "vite"]).isRequired, // 'react' | 'vite'
  isShowReactImage: PropTypes.bool,
